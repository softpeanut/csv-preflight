...
generic and bounded Shopify profiles. The licensed seller-held archive is complete at
`../../private-products/csv-preflight-pro/dist/csv-preflight-pro-v1.0.0.zip`. Buyers request an
order without posting data, receive a written 30-minute payment window, and receive the archive
through a buyer-only private GitHub repository after verified payment. Product terms and the
separate service scope remain distinct.
